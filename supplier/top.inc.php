...
if (isset($_SESSION['SUPPLIER_LOGIN']) && $_SESSION['SUPPLIER_LOGIN'] != '') {
} else {
         ...
         <div class="top-right">
            <div class="header-menu">
               <div class="user-area dropdown float-right">
                  <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome <?php echo $_SESSION['SUPPLIER_EMAIL']?></a>
