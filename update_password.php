...
$row=mysqli_fetch_assoc(mysqli_query($con,"select password from customer where id='$uid'"));

if($row['password']!=$current_password){
	echo "Please enter your current valid password";
}else{
	mysqli_query($con,"update customer set password='$new_password' where id='$uid'");
